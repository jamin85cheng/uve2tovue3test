  ...
  <div class="app-container">
    <el-row>
      <el-col :span="24" class="card-box">
        <el-card>
          <div slot="header"><span>基本信息</span></div> <!-- Redis 实例的基础运行指标展示 -->
      ...
      <el-col :span="12" class="card-box">
        <el-card>
          <div slot="header"><span>命令统计</span></div> <!-- 通过饼图展示各命令的调用占比 -->
          <div class="el-table el-table--enable-row-hover el-table--medium">
      ...
      <el-col :span="12" class="card-box">
        <el-card>
          <div slot="header">
            <span>内存信息</span> <!-- 通过仪表盘展示当前内存使用峰值（used_memory_human） -->
          </div>
          <div class="el-table el-table--enable-row-hover el-table--medium">
...
export default {
  ...
  methods: {
    /** 查询缓存信息：基本信息(info)、数据库键数量(dbSize)、命令统计(commandStats)、内存使用(used_memory_human)；渲染饼图与仪表盘展示 Redis 运行状态。 */
    getList() {
