...
export default {
  ...
  methods: {
    /** 查询服务器信息：包含 CPU(cpuNum/used/sys/free)、内存(mem total/used/free/usage)、Python进程(pyimp name/version/startTime/runTime/home/usage)、服务器信息(sys computerName/osName/computerIp/osArch/userDir)、磁盘状态(sysFiles 列表)。 */
    getList() {
