<template>
  <div class="app-container">
    <!-- 服务监控（Python版）：展示CPU、内存、服务器系统信息、Python进程信息与磁盘分区使用率。
         数据来源：后端 /monitor/server 接口，页面创建时拉取并通过 $modal 显示加载遮罩。 -->
    <el-row>
...
export default {
  ...
  data() {
    return {
      // 服务器信息
      server: []   // 后端返回的聚合对象：cpu、mem、sys、pyimp、sysFiles
    }
  },
  created() {
    this.getList()       // 拉取监控数据
    this.openLoading()   // 打开加载遮罩
  },
  methods: {
    /** 查询服务器信息 */
    getList() {
