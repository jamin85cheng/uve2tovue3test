<template>
  <div class="app-container">
    <!-- 查询条件：tableName(表名称)、tableComment(表描述)、dateRange(创建时间范围)；搜索触发 handleQuery，重置触发 resetQuery。 -->
    ...
    <!-- 操作区：生成代码、导入表、修改、删除；按钮权限由 v-hasPermi 控制。 -->
    ...
    <!-- 列表说明：tableName(表名)、tableComment(描述)、className(实体名)、createTime/UpdateTime；操作列为预览/编辑/删除/同步/生成代码。 -->
